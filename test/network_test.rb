...
class NetworkTest < MiniTest::Test
  ...
  def test_actors_by_show
    ...
    result = nbc.actors_by_show

    assert_equal ["David Hasselhoff", "William Daniels"], result[knight_rider]
    assert_equal ["Amy Poehler", "Nick Offerman"], result[parks_and_rec]
  end
  ...
  def test_shows_by_actor
    ...
    result = {"David Hasselhoff" => [knight_rider, baywatch],
